...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            'fullname'          => \Yii::t('user', 'Nama Penuh'),
    ...
    public function scenarios()
    {
        ...
        return ArrayHelper::merge($scenarios, [
            ...
            'update'   => ['username', 'email', 'password', 'fullname'],
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if ($insert) {
            if ($this->_profile == null) {
                ...
                \Yii::$app->db->createCommand("INSERT INTO auth_assignment (item_name,user_id,created_at) VALUES ('Staff',". $this->id .",UNIX_TIMESTAMP(NOW())) ")->execute();
            }

...
class AdminController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($user->load(\Yii::$app->request->post()) && $user->create()) {
			$itemname = \Yii::$app->request->post('role') == '' ? 'Staff' : \Yii::$app->request->post('role');
			\Yii::$app->db->createCommand("UPDATE auth_assignment SET item_name='".$itemname."' WHERE user_id=". $user->id ." ")->execute();
			if($itemname == 'Guru'){
				\Yii::$app->db->createCommand("INSERT INTO guru (id_guru,nama_guru) VALUES ('". $user->id ."','". $user->fullname ."') ")->execute();
			}
    ...
    public function actionUpdate($id)
    {
        ...
        if ($user->load(\Yii::$app->request->post()) && $user->save()) {
			$itemname = \Yii::$app->request->post('role') == '' ? 'PT' : \Yii::$app->request->post('role');
			\Yii::$app->db->createCommand("UPDATE auth_assignment SET item_name='".$itemname."' WHERE user_id=".$user->id." ")->execute();
